...
const baseQuery = fetchBaseQuery({
  ...
  prepareHeaders: (headers, { getState }) => {
    ...
    headers.set(
      "authorization",
      `Bearer eyJhbGciOiJIUzUxMiIsInR5cCI6IkpXVCJ9..NOSdCHkkxRtfygQrUEK2UoyY1XU8Jj_1LE_Gl8QJBEdkQrXK5uEkEd-nJjaT4G3-yaWo_9r1zZcvY5MSDldDeQ`
    );
    // }
    return headers;
  },
